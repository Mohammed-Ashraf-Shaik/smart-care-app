(function () {
    ...
    let isBooting = true;
    const views = () => ({ landing: window.App.Views.Landing, patient: window.App.Views.Patient, doctor: window.App.Views.Doctor, queue: window.App.Views.Queue, staff: window.App.Views.Staff, login: window.App.Views.Login, analytics: window.App.Views.Analytics, about: window.App.Views.Info, terms: window.App.Views.Info, privacy: window.App.Views.Info, notFound: window.App.Views.NotFound });
