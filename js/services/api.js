            ...
            const fetchOverpass = async radius => {
                try {
                    ...
                    return (data.elements || []).map(item => {
                        ...
                        return { id: `osm-${item.id}`, name: tags.name || tags['addr:housename'] || 'Medical Center', lat: itemLat, lng: itemLng, type: tags.amenity || tags.healthcare || 'hospital', openingHours: tags.opening_hours || 'Hours not listed', source: 'OpenStreetMap' };
