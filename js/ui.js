    ...
    const footer = (compact = false) => compact ? `
        ...
        <footer class="site-footer" data-section="site-footer">
            <div class="footer-grid">
                ...
                <div><p class="footer-heading">Explore</p><a data-route="/about" href="/about">About us</a><a data-route="/dashboard/patient/apply/1" href="/dashboard/patient/apply/1">Patient portal</a><a data-route="/login" href="/login">Provider portal</a></div>
