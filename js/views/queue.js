(function () {
    ...
    window.App.Views.Queue = function () {
        ...
        const renderRows = () => {
            ...
            if (!filtered.length) { region.innerHTML = `<div class="provider-empty">${icon('inbox', 30)}<p>No queue entries match those filters.</p><a class="btn-primary btn-icon" data-route="/apply" href="/apply">Preview patient flow ${icon('arrow-right', 16)}</a></div>`; return; }
