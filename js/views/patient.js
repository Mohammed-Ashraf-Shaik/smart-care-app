(function () {
    ...
    window.App.Views.Patient = function () {
        const { state, setStep, updatePatientData, updateQueue, setView, persistDraft } = window.App.Store;
